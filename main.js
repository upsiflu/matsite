...
var $author$project$Data$anarchive = A2(
	$rtfeldman$elm_css$Html$Styled$iframe,
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'width', '100%'),
			...
			$rtfeldman$elm_css$Html$Styled$Attributes$src('https://www.are.na/moving-across-thresholds/library-of-worded-companions/embed'),
			$rtfeldman$elm_css$Html$Styled$Attributes$title('Moving Across Thresholds - AnArchive')
		]),
	_List_Nil);
...
var $author$project$Layout$dense = A2(
		...
		$rtfeldman$elm_css$Html$Styled$p(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$maxWidth($author$project$Layout$rhythm.columnWidth),
							$rtfeldman$elm_css$Css$fontFamilies(
							_List_fromArray(
								['subarumedium', 'sans'])),
							$rtfeldman$elm_css$Css$lineHeight($author$project$Layout$rhythm.denseLine),
							A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$zero, $author$project$Layout$rhythm.padding),
							A4($rtfeldman$elm_css$Css$margin4, $rtfeldman$elm_css$Css$zero, $rtfeldman$elm_css$Css$zero, $author$project$Layout$rhythm._break, $rtfeldman$elm_css$Css$zero)
						]))
				]))));
...
var $author$project$Layout$h2 = function (t) {
	var sanitisedString = A3($elm$core$String$replace, ' ', '-', t);
	return A3(
		$elm$core$Basics$composeR,
		$elm$core$List$singleton,
		$rtfeldman$elm_css$Html$Styled$a(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href('#' + sanitisedString),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									['subarumedium', 'sans'])),
								A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$zero, $author$project$Layout$rhythm.padding),
								$rtfeldman$elm_css$Css$fontSize($author$project$Layout$rhythm._default),
								A4($rtfeldman$elm_css$Css$margin4, $author$project$Layout$rhythm._break, $rtfeldman$elm_css$Css$zero, $rtfeldman$elm_css$Css$zero, $rtfeldman$elm_css$Css$zero)
							])),
						$rtfeldman$elm_css$Html$Styled$Attributes$id(sanitisedString)
					])),
...
var $author$project$Layout$theme = {
	b0: A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0),
	b1: A4($rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.1),
	bp: A3($rtfeldman$elm_css$Css$rgb, 80, 80, 255),
	f0: A4($rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.9),
	f1: A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	fa: A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	fb: A3($rtfeldman$elm_css$Css$rgb, 0, 255, 0),
	fp: A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	li: A3($rtfeldman$elm_css$Css$rgb, 80, 80, 255)
};
var $rtfeldman$elm_css$Css$visited = $rtfeldman$elm_css$Css$pseudoClass('visited');
var $author$project$Layout$h1 = function (t) {
	var sanitisedString = A3($elm$core$String$replace, ' ', '-', t);
	return A3(
		$elm$core$Basics$composeR,
		$elm$core$List$singleton,
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$color($author$project$Layout$theme.li)
								])),
							...
							$author$project$Layout$theme.li),
							$rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$block),
							A2($rtfeldman$elm_css$Css$padding2, $author$project$Layout$rhythm.verticalPadding, $author$project$Layout$rhythm.padding),
							$rtfeldman$elm_css$Css$maxWidth($author$project$Layout$rhythm.columnWidth)
						]))
				])),
		A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									['subaruheavy', 'sans'])),
								$rtfeldman$elm_css$Css$fontSize($author$project$Layout$rhythm._default),
								$rtfeldman$elm_css$Css$lineHeight($author$project$Layout$rhythm._default),
...
var $author$project$Layout$header = $author$project$Layout$h1;
var $author$project$Layout$p = A2(
	$elm$core$Basics$composeR,
	$rtfeldman$elm_css$Html$Styled$text,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Layout$section = $rtfeldman$elm_css$Html$Styled$section(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					A2($rtfeldman$elm_css$Css$margin2, $rtfeldman$elm_css$Css$zero, $author$project$Layout$rhythm.minMargin)
				]))
		]));
...
var $author$project$Layout$typography = $rtfeldman$elm_css$Css$Global$global(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$color($author$project$Layout$theme.f0),
					$rtfeldman$elm_css$Css$backgroundColor($author$project$Layout$theme.b0),
					$rtfeldman$elm_css$Css$fontFamilies(
					_List_fromArray(
						['subarubook', 'sans'])),
			...
			A2(
			$rtfeldman$elm_css$Css$Global$selector,
			'div, p, a, section, article, header, footer, main',
			_List_fromArray(
				[
...
var $author$project$Data$vimeo = A2(
	$rtfeldman$elm_css$Html$Styled$iframe,
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'width', '100%'),
			...
			$rtfeldman$elm_css$Html$Styled$Attributes$src('https://player.vimeo.com/video/643915247?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;quality=1080p&amp;dnt=1'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'frameborder', '0'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'allowfullscreen', 'allowfullscreen'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-rocket-lazyload', 'fitvidscompatible'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-lazy-src', 'https://player.vimeo.com/video/643915247?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;quality=1080p&amp;dnt=1'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-ll-status', 'loaded'),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Layout$typography,
				$author$project$Layout$section(
				_List_fromArray(
					[
						$author$project$Layout$header('Fatigue as creative proposition'),
						$author$project$Layout$p('This is the new Moving Across Thresholds website. Right now, you can’t see anything yet. This week, I’ll create the prototype, and a link to test it will appear here.'),
						$author$project$Layout$h2('This Subheading is weirdäö@%&äÄ\''),
						$author$project$Layout$dense('For more concrete discussion of content and structure, check out these collaborative docs.'),
						$author$project$Layout$p('This is the new Moving Across Thresholds website. Right now, you can’t see anything yet. This week, I’ll create the prototype, and a link to test it will appear here.'),
						$author$project$Layout$p('This is the new Moving Across Thresholds website. Right now, you can’t see anything yet. This week, I’ll create the prototype, and a link to test it will appear here.')
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($rtfeldman$elm_css$Css$rgb, 100, 200, 200))
							]))
					]),
				_List_fromArray(
					[$author$project$Data$anarchive])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
