      ...
      const unsub = onSnapshot(
        ...
        doc => {
          requestAnimationFrame(() => {
            /* console.log(
              "(In requestAnimationFrame) received snapshot. db/log/entries - Current actions: ",
              doc.data().actions
            ); */
            console.log("On Snapshot");
            console.log("ON SNAPSHOT -- appendLog", appendLog);
            console.log(doc.data().actions);
            appendLog.dispatchEvent(new CustomEvent("e", { detail: "from JS" }));
